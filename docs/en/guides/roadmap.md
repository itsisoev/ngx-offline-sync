...
**Documentation:** English · [Русский](../../ru/guides/roadmap.md) · [日本語]()
...
As each major item ships, it will get its own file under [Configuration](configuration/index.md) — the same way [batchSize](configuration/batch-size.md) does now.

## Next

- [Limitations](limitations.md) — what to account for right now, ahead of the roadmap
